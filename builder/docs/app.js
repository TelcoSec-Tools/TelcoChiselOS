...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateFilterCounts() {
        const counts = { all: toolsCatalog.length, sdr: 0, gsm: 0, lte: 0, "5g": 0, ue: 0, sim: 0, ran: 0, device: 0, network: 0, voip: 0, sys: 0 };
    ...
    function renderTools() {
        ...
        filteredTools.forEach(tool => {
            ...
            switch (tool.category) {
                ...
                case "gsm": catTag = '<span class="tag tag-gsm">GSM/2G</span>'; break;
                case "lte": catTag = '<span class="tag tag-lte">LTE/4G</span>'; break;
                ...
                case "device": catTag = '<span class="tag tag-device">Device</span>'; break;
                case "network": catTag = '<span class="tag tag-network">Network</span>'; break;
