...
echo -e "  ${YELLOW}sudo telcosec-pkg install full${NC}             # Install complete 100-tool suite"
echo ""
...
echo -e "  10. ${BLUE}telcochisel-meta-full${NC}     (alias: ${YELLOW}full${NC})       - Complete TelcoChisel distribution umbrella (100 tools)"
echo ""
