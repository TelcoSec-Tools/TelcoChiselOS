...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      ...
      link: [
        {
          rel: 'stylesheet',
          href: 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Space+Mono:ital,wght@0,400;0,700;1,400&family=IBM+Plex+Mono:ital,wght@0,300;0,400;0,500;0,600;1,400&family=Barlow+Condensed:wght@400;600;700&display=swap',
  ...
  site: {
    ...
    name: 'TelcoChisel',
    description: 'TelcoChisel by TelcoSec is the ultimate free bootable Linux OS for advanced Telecom Security research. Ships with 88 pre-configured tools for SDR analysis, baseband auditing, and cellular penetration testing.',
    defaultLocale: 'en',
  },
