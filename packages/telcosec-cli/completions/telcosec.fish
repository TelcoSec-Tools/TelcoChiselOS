...
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile 5g-sa scan academy feedback completion version help" -a search -d "Search installed 94 tools and desktop launchers by keyword"
