...
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile 5g-sa scan academy feedback completion version help" -a search -d "Search installed 100 tools and desktop launchers by keyword"
...
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a pkg -d "Official modular metapackage manager"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a sim -d "Smartcard, SIM and eSIM auditing suite"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a 5g-sa -d "5G Standalone core and RAN lifecycle manager"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a scan -d "Interactive protocol assessment wizard"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a academy -d "Access TelcoSec Academy interactive labs"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a feedback -d "Community support and SourceForge reviews"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a completion -d "Generate shell completion script"
complete -c telcosec -n "not __telcosec_using_subcommand check status hardware search docs sdr 10g firmware profile pkg sim 5g-sa scan academy feedback completion version help" -a version -d "Show release version and kernel details"
...
complete -c telcosec -n "__telcosec_using_subcommand sim" -a "status readers atr trace lpac shell"
