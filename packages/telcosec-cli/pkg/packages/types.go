...
var CanonicalRegistry = []Metapackage{
	{
		...
		Tools: []string{
			...
			"TelcoSec APN Permutator (telcosec-apn-permutator) GTP endpoint discovery",
	...
	},
	{
		...
		Tools: []string{
			...
			"sdr-info unified multi-vendor SDR transceiver probe",
	...
	},
	{
		...
		Tools: []string{
			...
			"Falcon (LTE Security Analyzer) rogue base station detection framework",
	...
	},
	{
		...
		Tools: []string{
			...
			"telcosec-ran-status live real-time RAN emission and gNodeB telemetry",
	...
	},
	{
		...
		Tools: []string{
			...
			"TelcoSec IMSI Generator (telcosec-imsi-generator) subscriber range utility",
	...
	},
	{
		...
		Description: "Complete TelcoChisel telecom security distribution umbrella (100 tools)",
		Tools: []string{
			"All 11 domain metapackages installed concurrently",
			"All 100 telecom security and penetration testing utilities",
